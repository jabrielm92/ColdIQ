...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://cold-email-ai-2.preview.emergentagent.com').rstrip('/')
    ...
    def test_checkout_session_starter_monthly(self, auth_token):
        ...
        response = requests.post(f"{BASE_URL}/api/billing/create-checkout-session", 
            ...
            json={
                ...
                "origin_url": "https://cold-email-ai-2.preview.emergentagent.com"
            }
        )
