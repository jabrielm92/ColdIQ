...
function renderAnalysisResult(panel, analysis) {
  ...
  content.innerHTML = `
    ...
    <a href="https://coldiq-dashboard.preview.emergentagent.com/history" target="_blank" class="coldiq-cta">
      View Full Analysis →
    </a>
  `;
...
function renderError(panel, message, showLogin = true) {
  ...
  content.innerHTML = `
    <div class="coldiq-error">
      ...
      <p>${message}</p>
      ${showLogin ? `
        <a href="https://coldiq-dashboard.preview.emergentagent.com/login" target="_blank" class="coldiq-cta">
          Log in to ColdIQ
        </a>
      ` : ''}
    </div>
